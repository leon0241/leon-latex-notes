...
\textbf{Solution:} Let $\epsilon > 0$ be given. Set $\delta = \text{\_\_\_}$. Then for all $x\in \R$ such that $\lvert x - \text{\_\_\_ }\rvert$ we have
\vspace{0pt}\newline
"Same steps as rough working"
\[\text{\_\_\_ } \lvert x - \text{\_\_\_ }\rvert < \text{\_\_\_ }\delta = \epsilon\]
\end{xmp}
\vspace{-5pt}
...
\begin{xmp}[$\epsilon-\delta$ Discontinuity]{ex:discontinuity}{)}
    ...
    \[\begin{aligned}
        ...
        \frac{1}{\frac{\pi}{2}+2N\pi} &< \delta \quad \text{(will always be positive since N will be a positive integer)}\\ 
