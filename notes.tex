...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item If $(a_n)_{n\in\N}$ doesn't converge to $0$, then $\sum_{n=1}^{\infty} a_n$ diverges.
        \item The converse is not true! $a_n\to0$ does not imply $\sum_{n=1}^{\infty} a_n$ converges
    \end{itemize}
\end{itemize}
\end{thm}
