...
\begin{dfn}[Open Covers and Subcovers]{dfn:open-covers-subcovers}{}
...
\begin{dfn}[Compacting Compactness]{dfn:compactness}{}
    Let $X = \mathbb{R}$ and $d$ be the standard metric. Let $K$ be a subset of $\mathbb{R}$
    \textrule{\textbf{Compactness}}

    \vspace{-2pt}
    The following definitions are equivalent:
    \vspace{-5pt}
    \begin{enumerate}[leftmargin=*]
        \item $K$ is said to be \textbf{compact} iff every sequence of elements of $K$ has a subsequence that converges to an element of $K$
        \item $K$ is \textbf{compact} iff every open cover of $K$ has a finite subcover
    \end{enumerate}
    \vspace{-5pt}
    \textrule{\textbf{Sequential Compactness}}
    \vspace{-8pt}
    \begin{enumerate}[leftmargin=*]
        \item[3.] $K$ is \textbf{sequentially compact} iff every sequence in $K$ has a subsequence that converges to an element of $K$

            For the case $K = X$ it's just the definition $(1)$ defined above
    \end{enumerate}

    \vspace{-5pt}
    \textrule{\textbf{Uniform Continuity}}

    \vspace{-5pt}
    \begin{enumerate}[leftmargin=*]
        \item[4.] Let $(X, d_{X}), (Y, d_{Y})$ be metric spaces. A function $f : X \to Y$ is said to be \textbf{uniformly continuous} iff for every $\epsilon>0$ there exists a $\delta>0$ such that, for all $x, x'$ in $X$ with $d_{X}(x, x') < \delta$ we have
            \[d_{Y}(f(x), f(x')) < \epsilon\]
    \end{enumerate}

    \vspace{-3pt}
    \textrule{\textbf{Totally bounded Spaces}}
    \vspace{-8pt}
    \begin{enumerate}[leftmargin=*]
        \item[5.] A metric space $(X, d)$ is said to be \textbf{totally bounded} iff for every positive $\delta$, $X$ can be covered by a finite number of open balls of radius $\delta$.
        \item[6.] If $(X, d)$ is totally bounded then it is bounded, but the converse is not necessarily true
    \end{enumerate}
...
\begin{thm}[Lebesgue's Lemma]{thm:lebesgue-lemma}{}
    ...
    \longrule{0.08ex}
    \textbf{Lemma}: Let $(X, d)$ be a sequentially compact metric space and $X = \bigcup_{i\in I} G_{i}$ be an open cover of $X$. Then there exists a $\delta > 0$ such that any nonempty subset of $X$ of diameter $< \delta$ can be covered by a single $G_{i}$
\end{thm}



\begin{thm}[big theorem bank of obvious shit]{thm:compactness-thms}{}
    \vspace{-5pt}
    ...
    \begin{itemize}[leftmargin=*]
        \item For a set $K$ in $\mathbb{R}$ with the standard metric:
            \vspace{-5pt}
            \begin{itemize}
                \item $K$ is compact $\iff$ $K$ is closed and bounded
                \item $K$ is compact $\iff$ every open cover of $K$ has a finite cover
            \end{itemize}
        ...
        \item For a set $K$ in $\mathbb{R}$
            \vspace{-5pt}
            \begin{itemize}
                \item Every open cover of $K$ has a finite subcover $\implies$ $K$ is closed and bounded $\implies$ $K$ is compact
            \end{itemize} 

        \vspace{-5pt}
        \item Every open cover of the interval $[a, b]$, where $a, b\in \mathbb{R}$, $a \le b$ has a finite subcover
    ...
    \begin{itemize}[leftmargin=*]
        \item Let $K\ne\emptyset$, and let $d_{K}$ be the induced metric on $K$.
            \vspace{-3pt}
            \begin{itemize}
                \item $K$ (sequentially) compact $\iff$ the metric space $(K, d_{K})$ is (sequentially) compact
            \end{itemize}
            
            \vspace{-2pt}
    \item $K$ sequentially compact $\implies$ $K$ is closed and bounded

    \item $(X, d)$ and $K$ are both sequentially compact $\iff$ $K$ is closed

    \item $(X, d)$ is sequentially compact $\implies$ $(X, d)$ is complete
    \item $(X, d)$ is compact $\implies$ $(X, d)$ is sequentially compact

    \item $K$ is compact $\iff$ $K$ is sequentially compact

    \item $(X, d)$ is compact, and let $A$ be an infinite subset of $X$ $\implies$ $A$ has at least one limit point
    \end{itemize}
    ...
    \vspace{-5pt}
    \begin{itemize}[leftmargin=*]
        \item $(X, d)$ is sequentially compact $\implies$ $(X, d)$ is totally bounded
        \item $(X, d)$ is compact $\iff$ $(X, d)$ complete and totally bounded
    \end{itemize}
    \vspace{-5pt}
