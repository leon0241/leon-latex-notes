...
\begin{xmp}[Topological Invariancy Proofs]{xmp:topological-invariancy}{E}
	\begin{itemize-zero}
...
\begin{xmp}[Compact Sets]{xmp:compact-sets}{C}
	\begin{itemize-tight}
...
\begin{xmp}[Homeomorphisms]{xmp:punctured-sphere}{B}
	\begin{itemize-zero}
...
\begin{xmp}[Random counterexample]{xmp:counterexamples}{F}
	\begin{itemize-tight}
...
\begin{xmp}[Compactification]{xmp:compactification}{G}
	\begin{itemize-zero}
