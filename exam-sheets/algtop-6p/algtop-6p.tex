...
\begin{xmp}[Indecipherable Proof of \texorpdfstring{$\mathbb{S}^{1}$}{S1}]{xmp:proof-s1}{A}
...
\begin{xmp}[Proof of results of \texorpdfstring{$\mathbb{S}^{1}$}{S1}]{xmp:s1-results}{B}
