...
\usepackage{../../rss/thmboxes_v3}
\usepackage{../../rss/customs}
\usepackage{float}
% \usepackage{setspace}
...
\begin{dfn}[Open Ball]{def:open-ball}{8}
    ...
    \vspace{-5pt}
    \textrule{\textbf{Boundedness and Distance Set}}
...
\begin{rem}[Infinite open sets]{thm:infinite-open-sets}{35}
    ...
    \vspace{-2pt}
    \textrule{\textbf{Remark 38 (Infinite Closed Sets)}}
...
\begin{thm}[Continuity for Open and Closed Sets]{def:continuity-open-sets}{59}
    \vspace{-5pt}
...
\begin{dfn}[Compacting Compactness]{dfn:compactness}{M}
    \vspace{-5pt}
    \textrule{\textbf{Def 102 (Compactness and Sequential Compactness)}}
...
\begin{thm}[Picard's Theorem]{thm:picard}{V}
...
\begin{xmp}[Past Paper Questions]{xmp:ppqs}{X}
