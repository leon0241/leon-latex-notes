...
% see you guys in UG4 category theory! (jk they're not running it next year..)
...
\vspace{-5pt}
\begin{dfn}[Ideals and Submodules]{dfn:ideal}{E}
    \vspace{-5pt}
    ...
    % \textbf{Note}: Submodules are basically the module version of an ideal
    \vspace{-7pt}
    \noindent\rule{\textwidth}{0.2pt}
    \vspace{-23pt}
    \setlength{\columnseprule}{0.5pt}
    ...
    % (\textbf{Note}: it's literally the same def lol)
    \vspace{-10pt}
    \noindent\rule{\textwidth}{0.2pt}
...
\vspace{-5pt}
\begin{thm}[Ideals and Submodule Theorems/Lemmas]{thm:kernels-as-ideals}{F}
...
\begin{dfn}[Equivalence Relations]{dfn:equivalence-relations}{G}
    \vspace{-5pt}
...
\vspace{-5pt}
\begin{thm}[Universal Properties and First Iso Thm]{univ-prop-first-iso-thm}{I}
    \vspace{-5pt}
...
\begin{dfn}[Random tidbits about Linear Mappings]{dfn:linear-mappings}{1.7.1}
