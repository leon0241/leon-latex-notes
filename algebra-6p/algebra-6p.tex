...
\begin{dfn}[Definition of a field]{dfn:field}{1.2.1}
...
\begin{dfn}[Vector Subspace]{dfn:vector-subspace}{1.4.1}
...
\begin{dfn}[Power sets]{dfn:powersets}{1.4.9}
...
\begin{dfn}[Basis of a Vector Space]{dfn:basis}{1.5.8}
...
\begin{thm}[Linear combination of basis elements]{thm:linear-combinations-of-basis-elems}{1.5.11}
...
\vspace{-5pt}
\begin{thm}[Characterisations of Bases]{thm:basis-characterisations}{1.5.12}
...
\vspace{-5pt}
\begin{dfn}[Free Vector Space]{dfn:free-vector-space}{1.5.15}
...
\vspace{-5pt}
\begin{thm}[Variant of Linear Combinations]{thm:lin-combinations-of-basis}{1.5.16}
...
\begin{thm}[Cardinality of Bases]{thm:cardinality-of-bases}{1.6.4}
...
\begin{thm}[Dimension Theorems]{thm:dimension-theorems}{1.6}
...
\vspace{-5pt}
\begin{thm}[Classifying VecSpaces by Dimension]{thm:classifying-vecspaces-by-dim}{1.7.7}
    Let $n$ be a natural number. Then a vector space over a field $F$ is isomorphic to $F^{n}$ iff it has dimension $n$
\end{thm}

\vspace{-5pt}
\begin{thm}[Linear Mapping and Bases]{thm:linear-maps-and-bases}{1.7.8}
...
\vspace{-5pt}
\begin{thm}[Inverse Mappings]{thm:inverse-mappings}{1.7.9}
...
\vspace{-5pt}
\begin{dfn}[Image and Kernel of a map]{dfn:image-kernel}{1.8.1}
...
\begin{thm}[Rank-Nullity / Dimension Theorem]{thm:rank-nullity}{1.8.4}
...
\begin{thm}[Representing Matrices]{thm:representing-matrices}{2.3.1}
...
\begin{thm}[Repr. Mat of Compositions]{thm:representing-matrix-of-composition}{2.3.2}
...
\newpage
\begin{dfn}[Representation of a vector image]{dfn:representation-vector}{2.3.4}
...
\begin{thm}[Change of Basis]{thm:change-of-basis}{2.4.3}
...
\begin{dfn}[Definition of a Ring]{dfn:ring}{3.1.1}
...
\begin{dfn}[Ring definition of a field]{dfn:field-ring}{3.1.8}
...
\begin{thm}[Properties of Rings]{dfn:ring-lemmas-1}{3.2}
...
\begin{dfn}[Unit of a ring]{dfn:ring-unit}{3.2.6}
...
\begin{dfn}[Ring of Polynomials]{dfn:polynomial-rings}{3.3.2}
...
\begin{thm}[Fundamental Theorem of Algebra]{thm:fundamental-theorem-of-algebra}{3.3.13}
    The field of complex numbers $\mathbb{C}$ is algebraically closed.
\end{thm}

\begin{thm}[Linear Factors of Closed Fields]{thm:alg-closed-fields-linear-factors}{3.3.14}
...
\begin{dfn}[Ring Homomorphisms]{dfn:ring-homomorphisms}{3.4.1}
...
\begin{dfn}[Generated Ideals]{dfn:ideal-generators}{3.4.11}
...
\begin{dfn}[Principal Ideal]{dfn:principal-ideal}{3.4.15}
...
\begin{dfn}[Equivalence Classes]{dfn:equivalence-classes}{3.5.3}
...
\begin{dfn}[Set of Equivalence Classes]{dfn:equivalence-class-sets}{3.5.5}
...
\begin{dfn}[Factor Ring]{dfn:factor-ring}{3.6.3}
...
\begin{thm}[Universal Property of Factor Rings]{thm:univ-prop-of-factor-rings}{3.6.7}
...
\begin{thm}[First Isomorphism Theorem for Rings]{thm:first-iso-thm-rings}{3.6.9}
...
\begin{thm}[Module Lemmas]{thm:module-lemmas}{3.7.8}
...
\begin{dfn}[Module Homomorphisms]{dfn:module-homomorphismsa}{3.7.11}
...
\begin{dfn}[Generated Submodule lemmas]{dfn:generated-submod-lemmas}{3.7}
    \begin{itemize}
        \setlength\itemsep{0em}
...
\begin{thm}[Universal Prop. of Factor Modules]{thm:univ-prop-factor-mods}{3.7.32}
...
\begin{thm}[First Isomorphism Thm for Modules]{thm:first-iso-thm-modules}{3.7.33}
...
\begin{dfn}[Inversions of a permutation]{dfn:inversion}{4.1.2}
...
\newpage
\begin{thm}[Multiplicativity of the sign]{thm:permutation-multiplicativity}{4.1.5}
...
\begin{dfn}[Alternating Group of a Permutation]{dfn:alternating-group}{4.1.6}
...
\begin{dfn}[Complex Matrices]{dfn:unitary-matrices}{5.3.14}
...
\begin{dfn}[Field Construction]{dfn:field-constructon}{B}
    \noindent\rule{\textwidth}{0.2pt}
