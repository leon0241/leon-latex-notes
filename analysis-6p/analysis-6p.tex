...
\begin{dfn}[Trigonometric Polynomials]{dfn:trigonometric-polynomials}{5.6}
	...
	Observe that trigonometric polynomials are continuous functions. Moreover, from Euler's identity $e^{ix} = \cos(x) + i\sin(x),\, (x\in \mathbb{R})$ we see that every trigonometric polynomial can also be written in the alternate form
